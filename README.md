...
MongoDB – Pokémon storage, user accounts, trade history
...
- Pokémon-Store feature: Trade Pokémon with PokéCoins
- Able to store traded Pokémon into personal inventory
- Online PvP battles using owned Pokémon
